...
const DECKS = ['aula-capitulo', 'pitch-projeto', 'demo-tecnica', 'sandeco-just-animation-template', 'mira-perfect', 'albatroz-deco'];
const THEMES = ['mira-dark', 'light-minimal', 'corporate-blue', 'neon-emerald', 'albatroz-dark', 'albatroz-army', 'albatroz-deco', 'albatroz-deco-light'];
...
export default async function newDeck(args) {
  ...
  const animationOnly = deck === 'sandeco-just-animation-template' || deck === 'mira-perfect' || deck === 'albatroz-deco';
  if (!animationOnly) {
